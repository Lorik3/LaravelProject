...
<div class="background-image grid grid-cols-1 m-auto">
    ...
    <div class="sm:grid grid-cols-2 gap-20 w-4/5 mx-auto py-15 border-b      border-gray-200">
        ...
        <div class="m-auto sm:m-auto text-left w-4/5 block">
            ...
            <a href="/blog" class="uppercase bg-blue-500 text-gray-100 text-s font-extrabold py-3 px-3 rounded-3xl">Find Out More</a>
        </div>
    ...
    <div class="text-center py-15">
        ...
        <p class="m-auto w-4/5 text-gray-500">Lorem ipsum dolor sit amet consectetur adipisicing elit. Expedita maiores explicabo aspernatur, cum molestias at.</p>
    </div>
    ...
    <div class="sm:grid grid-cols-2 w-4/5 m-auto">
        <div class="flex bg-yellow-700 text-gray-100 pt-10">
            <div class="m-auto pt-4 pb-16 sm:m-auto w-4/5 block">
                ...
                <h3 class="text-xl font-bold py-10">Lorem ipsum dolor, sit amet consectetur adipisicing elit. Quos quibusdam eveniet veniam quia eius.</h3>
